...
abstract class $WalletCopyWith<$Res> {
  ...
  @useResult
  $Res call({String pubKey, num balance});
}
...
class _$WalletImpl implements _Wallet {
  const _$WalletImpl({required this.pubKey, required this.balance});
  ...
  @override
  String toString() {
    return 'Wallet(pubKey: $pubKey, balance: $balance)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, pubKey, balance);
...
abstract class _Wallet implements Wallet {
  const factory _Wallet(
      ...
      required final num balance}) = _$WalletImpl;
